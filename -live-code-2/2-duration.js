...
console.log(recursiveFormatDuration(86400)); // 1 menit 0 detik
...
const formatDuration = seconds => {
  if (seconds == 0) {
    ...
    return `${Math.floor(seconds / 3600)}:` + formatDuration(seconds % 3600);
  } else if (seconds >= 60) {
    return `${Math.floor(seconds / 60)}:` + formatDuration(seconds % 60);
  } else if (seconds > 0) {
    return `00:${seconds}`;
  }
}
...
// console.log(formatDuration(1)); // 0 detik
// console.log(formatDuration(2)); // 0 detik
// console.log(formatDuration(100)); // 0 detik
// console.log(recursiveFormatDuration(100)); // 0 detik
